                                                        ...
                                                        onPressed:
                                                            ((context) => {
                                                                  AwesomeDialog(
                                                                          ...
                                                                          btnOkOnPress:
                                                                              () {
                                                                            controller.deleteFirstAgunan(controller.debiturController.insightDebitur.value.agunan!.firstWhere((element) => element.kodeAgunan == 1).id!,
                                                                                'agunan_tanah');
                                                                          },
                                                                          btnOkText:
                                                                              'Oke sip',
                                                        ...
                                                        onPressed:
                                                            ((context) => {
                                                                  AwesomeDialog(
                                                                          ...
                                                                          btnOkOnPress:
                                                                              () {
                                                                            controller.deleteFirstAgunan(controller.debiturController.insightDebitur.value.agunan!.firstWhere((element) => element.kodeAgunan == 2).id!,
                                                                                'agunan_tanah');
                                                                          },
                                                                          btnOkText:
                                                                              'Oke sip',
                                                        ...
                                                        onPressed:
                                                            ((context) => {
                                                                  AwesomeDialog(
                                                                          ...
                                                                          btnOkOnPress:
                                                                              () {
                                                                            controller.deleteFirstAgunan(controller.debiturController.insightDebitur.value.agunan!.firstWhere((element) => element.kodeAgunan == 4).id!,
                                                                                'agunan_peralatan');
                                                                          },
                                                                          btnOkText:
                                                                              'Oke sip',
                                                        ...
                                                        onPressed:
                                                            ((context) => {
                                                                  AwesomeDialog(
                                                                          ...
                                                                          btnOkOnPress:
                                                                              () {
                                                                            controller.deleteFirstAgunan(controller.debiturController.insightDebitur.value.agunan!.firstWhere((element) => element.kodeAgunan == 5).id!,
                                                                                'agunan_cash');
                                                                          },
                                                                          btnOkText:
                                                                              'Oke sip',
                                                        ...
                                                        onPressed:
                                                            ((context) => {
                                                                  AwesomeDialog(
                                                                          ...
                                                                          btnOkOnPress:
                                                                              () {
                                                                            controller.deleteFirstAgunan(controller.debiturController.insightDebitur.value.agunan!.firstWhere((element) => element.kodeAgunan == 6).id!,
                                                                                'agunan_los');
                                                                          },
                                                                          btnOkText:
                                                                              'Oke sip',
                                                        ...
                                                        onPressed:
                                                            ((context) => {
                                                                  AwesomeDialog(
                                                                          ...
                                                                          btnOkOnPress:
                                                                              () {
                                                                            controller.deleteFirstAgunan(controller.debiturController.insightDebitur.value.agunan!.firstWhere((element) => element.kodeAgunan == 7).id!,
                                                                                'agunan_lainnya');
                                                                          },
                                                                          btnOkText:
                                                                              'Oke sip',
                                                        ...
                                                        onPressed:
                                                            ((context) => {
                                                                  AwesomeDialog(
                                                                          ...
                                                                          btnOkOnPress:
                                                                              () {
                                                                            controller.deleteFirstAgunan(controller.debiturController.insightDebitur.value.agunan!.firstWhere((element) => element.kodeAgunan == 3).id!,
                                                                                'agunan_kendaraan');
                                                                          },
                                                                          btnOkText:
                                                                              'Oke sip',
      ...
      bottomNavigationBar: Obx(
        () => Container(
          ...
          child: ElevatedButton.icon(
            ...
            label: controller.isAgunanInputProcessing.value
                ? const Center(
                    child: CircularProgressIndicator(
                      color: Colors.white,
                    ),
