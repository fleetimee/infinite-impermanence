...
Future<Uint8List> makeReviewerPdf(PengajuanDetail pengajuan) async {
        ...
        Column(
          ...
          children: [
            ...
            Align(
              ...
              child: Text(
                'TANGGAPAN PENGUSUL KOMITE KREDIT (REVIEWER)',
                style: TextStyle(
                  fontSize: 10,
                    ...
                    Table(
                      ...
                      children: [
                        ...
                        TableRow(
                          children: [
                            ListView.builder(
                              itemCount: pengajuan.bahasanReviewer?.length ?? 0,
                      ...
                      children: [
                        ...
                        TableRow(
                          children: [
                            Align(
                              alignment: Alignment.center,
                              child: textKolomAtas('Leader Kredit Mikro'),
                            ),
                            textKolomAtas(' '),
                          ],
                        ),
