                        ...
                        Obx(
                          () => controller.pendingController
                              ...
                              : controller.pendingController
                                      .listMyPendingPemutusan.isNotEmpty
                                  ? Text(
                                      "There are ${controller.pendingController.listMyPendingPemutusan.length} reviews left to complete",
                                  ...
                                  Obx(
                                    () => Row(
                                      children: [
                                        controller
                                                .pendingController
                                                .isMyPendingPemutusanProcessing
                                                .value
                                            ? const Text(
                                                "...",
                                                style: TextStyle(
                                            ...
                                            : controller
                                                    ...
                                                    .isNotEmpty
                                                ? Text(
                                                    "${controller.pendingController.listMyPendingPemutusan.length}",
                                                    style: const TextStyle(
                                                      fontSize: 20.0,
                                                      fontWeight:
                                                          FontWeight.bold,
                                  ...
                                  Obx(
                                    () => Row(
                                      children: [
                                        controller
                                                .completedController
                                                .isMyCompletedPemutusanProcessing
                                                .value
                                            ? const Text(
                                                "...",
                                                style: TextStyle(
                                            ...
                                            : controller
                                                    ...
                                                    .isNotEmpty
                                                ? Text(
                                                    "${controller.completedController.listMyCompletedPemutusan.length}",
                                                    style: const TextStyle(
                                                      fontSize: 20.0,
                                                      fontWeight:
                                                          FontWeight.bold,
                                    ...
                                    () => Row(
                                      children: [
                                        controller
                                            ...
                                            : controller
                                                        .completedController
                                                        .listMyCompletedPemutusanFilteredByAccepatance
                                                        .length
                                                        .toString() ==
                                                    "0"
                                                ? const Text(
                                          ...
                                          controller
                                              ...
                                              : controller
                                                  ...
                                                  : Text(
                                                      controller
                                                          .completedController
                                                          .listMyCompletedPemutusanFilteredByRejection
                                                          .length
                                                          .toString(),
                                                      style: const TextStyle(
                                                        fontSize: 16.0,
